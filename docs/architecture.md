...
> **dev ใช้พอร์ตมาตรฐานแล้ว** — `https://api.<ip>.nip.io`, `https://staff.<ip>.nip.io`,
> `https://dl.<ip>.nip.io` บนพอร์ต 443 เดียวกัน แยกด้วย SNI ส่วน :80 redirect ไป https ทั้งหมด
>
...
> ในระดับชื่อโฮสต์จริงๆ ไม่ใช่แค่คนละเลขพอร์ตบนชื่อเดียวกัน
