...
- เคยมีเหตุการณ์ **attestation key ของผู้ผลิตบางรายรั่ว** แล้วถูกนำไปใช้ปลอม (Google ทยอยเพิกถอน) → ควรตรวจ certificate revocation ด้วย
...
มาตรการลดความเสี่ยง:
- จำกัดขนาดไฟล์ 10 MB
- ถอดรหัสและส่งแบบ **stream ทีละ chunk ห้ามโหลดทั้งไฟล์เข้า memory**
...
| การกระทำ | limit | แจ้งเตือนเมื่อ |
|---|---|---|
| ใส่ PIN ยกระดับสิทธิ์ | 10 ครั้ง/ชม. | ผิดติดกัน 5 ครั้ง |
| ดูข้อมูลเต็ม | 60 ครั้ง/ชม. | เกิน limit หรือดูเกิน 20 คนใน 10 นาที |
| ดาวน์โหลดเอกสาร | 30 ครั้ง/ชม. | เกิน limit — **สัญญาณของการดูดข้อมูล** |

การดูดข้อมูลโดยเจ้าหน้าที่ที่มีสิทธิ์จริงเป็นสิ่งที่กันด้วยเทคนิคไม่ได้ — ตรวจจับได้อย่างเดียว
จึงต้องมีคนดู alert เหล่านี้จริง ไม่ใช่แค่เขียน log ทิ้งไว้
