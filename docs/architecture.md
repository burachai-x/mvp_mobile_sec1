...
> **ตารางด้านบนคือหน้าที่ตามการออกแบบ ไม่ใช่สิ่งที่ทำงานอยู่วันนี้**
> ตารางเวลาของ `scheduler` มีงานเดียวคือ `retention:apply` (ทุกวัน 03:15 · `routes/console.php`)
> ส่วน **ออก manifest ใหม่** และ **เตือนใบขับขี่หมดอายุ** ยังไม่มีโค้ด
> เอกสารฉบับนี้บอกว่าระบบ *ควรเป็น* อย่างไร · `README.md` หัวข้อ **สถานะ** บอกว่ามีอะไร *จริง*
> ถ้าสองที่ขัดกัน ให้ถือว่า README ถูก เพราะมันอ้างอิงโค้ดที่รันได้
