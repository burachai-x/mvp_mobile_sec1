...
| | |
|---|---|
| สถานะ | ยอมรับแล้ว — **ส่วนที่ว่าด้วย CI ถูกแทนที่โดย ADR 0008** (2026-09-21) |
| วันที่ | 2026-07-22 |
| เกี่ยวข้องกับ | `PRD.md` §2.1 · `docs/security/threat-model.md` S8 · ADR 0008 |

> ⚠️ **อ่านคู่กับ ADR 0008** — ข้อสรุป "Docker ครอบเฉพาะ backend, ไม่ build Flutter ใน Docker" ยังใช้อยู่
> แต่ทุกที่ในเอกสารนี้ที่บอกว่า build ผ่าน **CI** ไม่เป็นจริงแล้ว เพราะโปรเจกต์ไม่มี CI
> วิธี build release และที่เก็บ `.jks` ให้ดู ADR 0008
