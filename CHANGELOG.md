...
- **`release_notes` ใน update manifest รองรับหลายภาษา** — เป็น map ของรหัสภาษา
  แอปเลือกตามภาษาที่กำลังแสดงแล้วถอยไป `th` · `release_notes_th` เดิม **ยังอ่านอยู่และห้ามลบ**
  เพราะ manifest ที่ลงนามไปแล้วเซ็นใหม่จากระยะไกลไม่ได้ กุญแจอยู่ออฟไลน์ตามเจตนา (§7)
  · การ parse ฟิลด์นี้ถอยเป็น "ไม่มีหมายเหตุ" เมื่อเจอรูปแบบผิด แทนที่จะโยน exception
  ฟิลด์ที่เป็นแค่ข้อมูลประกอบต้องไม่ทำให้ช่องอัปเดตล้ม
